        ...
        #se for destruido entra aqui       
                ...
                if meteor.hp1>0:
                        ...
                        if meteor.nx1+meteor.mudX>=800 or meteor.nx1+meteor.mudY>=600:
                                ...
                                meteor.mudX=0
                                meteor.mudY=0
                #se o meteoro for destruido então  vai aparecer outro 3 asteroides medios              
                if meteor.hp1==0:
                        ...
                        #todos a seguir são 5 asteroides pequenos que aparecem caso 1 dos medios sejam destruidos
                        #caso a vida do asteroide medio chegue a 0 e a vida do proprio asteroid pequeno for acima de 0 então entra aqui
                        if meteor.auxhp<=0 and meteor.auxsmlhp1!=0:
                                #cria o asteroid pequeno
                                pygame.draw.circle(SCREEN,RED,[meteor.nx5+meteor.mudX4,meteor.nx5+meteor.mudY4],20) 
                                #caso o mesmo passe para fora do ecrã irá aparecer no local oposto do ecra
                                if meteor.nx5+meteor.mudX4>=800 or meteor.nx5+meteor.mudY4>=600:
                                        meteor.nx5=0
                                        meteor.mudX4=0.3
                                        meteor.mudY4=0.3 
                        #o mesmo acima segui para o restante do código
